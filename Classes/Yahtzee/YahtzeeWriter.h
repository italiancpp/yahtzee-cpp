...
public:
	...
	//
	void _startTurnFor(DicePlayer& player, size_t currentTurn, size_t totalTurns);
	...
	void endTurnFor(DicePlayer& player, const ScoreTable& currentScores, size_t justEndedTurn, size_t totalTurns);
	void gameOver();
