...
public:
	...
	virtual void diceRolledNoMoreShots(DicePlayer& player, const std::vector<Die>& dice, size_t currentShot, const ScoreTable& scores) = 0; // e.g. mostra il valore dei dadi
